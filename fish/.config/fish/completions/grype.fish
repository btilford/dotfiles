...
#   grype completion fish > fish/.config/fish/completions/grype.fish
# Regenerate after a grype upgrade. Committed rather than eval'd at shell
# start (the way workmux/obsidian-cli are) so no fish session pays for a grype
# subprocess; the zsh side does the same with zsh/.zfunc/_grype.
