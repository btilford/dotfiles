$env.PATH = ($env.PATH | split row (char esep) | where { $in != "/Users/btilford/Library/Application Support/carapace/bin" } | prepend "/Users/btilford/Library/Application Support/carapace/bin")
