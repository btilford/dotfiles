...
<!-- The "**Table of Contents**" line below is generated by markdown-toc. -->
...
- `tap-hold-next`: a combination of `tap-next` and `tap-hold`: like
  `tap-next`, but *also* switch to hold after a period of time.
...
KMonad allows you to define and operate on several *layers*; these are
