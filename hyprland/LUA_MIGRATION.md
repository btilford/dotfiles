...
1. **Dangling symlink**: `cp: not writing through dangling symlink '~/.config/hypr/wallpaper_effects/.wallpaper_current'`
2. **Missing wallust template**: `Reading ~/.config/wallust/templates/colors-hyprland.lua failed: No such file or directory`
...
```text
Reading ~/.config/wallust/templates/colors-hyprland.lua failed: No such file or directory
```
